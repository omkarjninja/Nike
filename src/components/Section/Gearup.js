...
import Gear from "../../images/gear1.jpg";import Gear2 from "../../images/gear2.jpg";
import Gear3 from "../../images/gear4.jpg";
const GearUp = () => {
    return (
        <div className="2xl:mx-auto 2xl:container lg:py-16 lg:px-40 xl:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col items-center justify-center">
                <h1 className="text-4xl font-semibold leading-9 text-gray-800">Gear Up</h1>
                <p className="text-base leading-6 text-center text-gray-600 sm:w-96 md:w-9/12 lg:w-5/12 mt-4">If you're looking for random GearUps, you've come to the right place. When a random word or a random sense isn't quite enough</p>
            </div>
